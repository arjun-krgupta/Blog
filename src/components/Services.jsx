    ...
    return (
        <>
            <div className='mt-14 '>
                ...
                <div className='flex flex-col w-full gap-3 items-center justify-center pt-10 pb-6 md:flex-row md:gap-0 md:justify-around lg:px-36'>
                    <div className='flex flex-col items-center gap-3 cursor-pointer hover:scale-[1.03] hover:transition-[0.3s] hover:text-[#0ef]'>
                        <div className="w-full sm:w-[380px] md:w-60 lg:w-80">
